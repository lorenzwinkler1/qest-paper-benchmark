...
GENETIC_ALGORITHM_CONFIGS = [
    ...
    (50, 100, 100, 1, 50, 200, 1, 5, 2, False),
    (50, 100, 100, 1, 200, 200, 1, 5, 2, True),

    (50, 20, 100, 1, 400, 400, 1, 5, 2, False),
    (50, 100, 100, 1, 400, 400, 1, 5, 2, True),
    ...
    for id, q1, p, q2, initial in RANDOM_WALKS:
        for i in range(NUM_RUNS):
            ...
            input = BenchmarkInput(
              id=id, q1 = q1, q2=q2, percentage=p, initial = initial, exactN0 = False, numGenerations=num_generations,
