...
data_imb_n <- read.csv("./output/random_walk/inputs/non-zero-mean/n.json.csv")
data_imb_const <- read.csv("./output/random_walk/inputs/non-zero-mean/const.json.csv")
...
data2 <- read.csv("./output/random_walk/inputs/different_p/1e-1_L.json.csv")
data3 <- read.csv("./output/random_walk/inputs/different_p/1e-1_R.json.csv")
data4 <- read.csv("./output/random_walk/inputs/different_p/1e-2_L.json.csv")
data5 <- read.csv("./output/random_walk/inputs/different_p/1e-2_R.json.csv")
data6 <- read.csv("./output/random_walk/inputs/different_p/1e-3_L.json.csv")
data7 <- read.csv("./output/random_walk/inputs/different_p/1e-3_R.json.csv")
