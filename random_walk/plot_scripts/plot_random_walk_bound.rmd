...
```{r}
data_imb_n <- read.csv("../output/inputs/non_zero_mean/n.json.csv")
data_imb_const <- read.csv("../output/inputs/non_zero_mean/const.json.csv")
...
data2 <- read.csv("../output/inputs/different_p/1e_1_L.json.csv")
data3 <- read.csv("../output/inputs/different_p/1e_1_R.json.csv")
data4 <- read.csv("../output/inputs/different_p/1e_2_L.json.csv")
data5 <- read.csv("../output/inputs/different_p/1e_2_R.json.csv")
data6 <- read.csv("../output/inputs/different_p/1e_3_L.json.csv")
data7 <- read.csv("../output/inputs/different_p/1e_3_R.json.csv")
